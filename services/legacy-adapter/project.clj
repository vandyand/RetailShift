(defproject retailshift/legacy-adapter "0.1.0-SNAPSHOT"
  :description "Legacy POS System Adapter for RetailShift"
  ...
  :main ^:skip-aot retailshift.legacy-adapter.core
  ...
  :aliases {"docker-build" ["shell" "docker" "build" "-t" "retailshift/legacy-adapter:latest" "."]
